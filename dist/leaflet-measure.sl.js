!(function(e) {
  ...
  function(e, t, r) {
    function n(e) {
      return null == e ? (void 0 === e ? l : a) : u && u in Object(e) ? i(e) : s(e);
    }
    var o = r(4),
      i = r(38),
      s = r(39),
  ...
  function(e, t, r) {
    function n(e) {
      ...
      var t = o(e);
      return (
        t == l || t == a || ('string' == typeof e.message && 'string' == typeof e.name && !s(e))
      );
    }
    var o = r(0),
      i = r(1),
            ...
            if (null !== (a = p ? c.geometries[g] : c)) {
              ...
              switch (((f = !r || ('Polygon' !== M && 'MultiPolygon' !== M) ? 0 : 1), M)) {
                case null:
                  break;
                case 'Point':
                  if (!1 === t(u, h, b, _, j)) return !1;
                  h++, _++;
                  break;
                case 'LineString':
                case 'MultiPoint':
                  for (o = 0; o < u.length; o++) {
                    if (!1 === t(u[o], h, b, _, j)) return !1;
                    h++, 'MultiPoint' === M && _++;
                  }
                  'LineString' === M && _++;
                  break;
                  ...
                  for (o = 0; o < u.length; o++) {
                    for ('MultiPolygon' === M && (j = 0), i = 0; i < u[o].length; i++) {
                      for (s = 0; s < u[o][i].length - f; s++) {
                        if (!1 === t(u[o][i][s], h, b, _, j)) return !1;
                        h++;
                      }
                      j++;
                    }
        ...
        for (
          ...
          if (null !== (i = l ? a.geometries[o] : a))
            switch (i.type) {
              ...
              case 'MultiLineString':
              case 'MultiPolygon':
                if (!1 === t(i, f, u, c, p)) return !1;
                break;
              case 'GeometryCollection':
                for (n = 0; n < i.geometries.length; n++)
                  if (!1 === t(i.geometries[n], f, u, c, p)) return !1;
                break;
              default:
                throw new Error('Unknown Geometry Type');
            }
  ...
  function(e, t, r) {
    ...
    var o = r(31),
      ...
      M = {
        measure: 'Meritve',
        measureDistancesAndAreas: 'Meritve razdalj in površin',
        createNewMeasurement: 'Napravi novo meritev',
        startCreating: 'Izvedi meritev z vstavljanjem točk v zemljevid',
        finishMeasurement: 'Končaj meritev',
        lastPoint: 'Zadnja točka',
        area: 'Površina',
        perimeter: 'Rob',
        pointLocation: 'Položaj točke',
        areaMeasurement: 'Izmerjena površina',
        linearMeasurement: 'Izmerjena razdalja ',
        pathDistance: 'Razdalja vzdolž poti ',
        centerOnArea: 'Centriraj na to površino',
        centerOnLine: 'Centriraj na to vrstico',
        centerOnLocation: 'Centriraj na ta kraj',
        cancel: 'Prekliči',
        delete: 'Briši',
        acres: 'jutri',
        feet: 'čevelj',
    ...
    (L.Control.Measure = L.Control.extend({
      ...
      _initLayout: function() {
        ...
        (t.innerHTML = y({ model: { className: e }, labels: this.options.labels })),
      ...
      buildDisplay: function(e, t, r, n, o) {
        if (t && this.options.units[t]) {
          var i = this.formatMeasure(e, this.options.units[t], n, o);
          if (r && this.options.units[r]) {
            i = i + ' (' + this.formatMeasure(e, this.options.units[r], n, o) + ')';
          }
          return i;
        }
      ...
      _handleMeasureDoubleClick: function() {
        ...
        if ((this._finishMeasure(), e.length)) {
          ...
          i.innerHTML = r;
          var s = (0, c.selectOne)('.js-zoomto', i);
          s &&
          ...
          var a = (0, c.selectOne)('.js-deletemarkup', i);
          a &&
            ...
            t.addTo(this._layer),
            t.bindPopup(i, this.options.popupOptions),
            t.getBounds
  ...
  function(e, t, r) {
    function n(e, t, r) {
      ...
      (A = (O ? A.replace(v, '') : A).replace(y, '$1').replace(b, '$1;')),
        (A =
          'function(' +
          (T || 'obj') +
          ') {\n' +
  ...
  function(e, t, r) {
    function n(e, t, r, n) {
      ...
      for (var a = -1, l = t.length; ++a < l; ) {
        ...
        void 0 === c && (c = e[u]), s ? i(r, u, c) : o(r, u, c);
      }
      return r;
    }
    var o = r(34),
  ...
  function(e, t, r) {
    function n(e) {
      return !(!s(e) || i(e)) && (o(e) ? d : u).test(a(e));
    }
    var o = r(10),
      i = r(40),
      s = r(2),
  ...
  function(e, t, r) {
    function n(e, t, r) {
      return (
        ...
        function() {
          for (var n = arguments, s = -1, a = i(n.length - t, 0), l = Array(a); ++s < a; )
            l[s] = n[t + s];
          s = -1;
    ...
    function s(e) {
      ...
      if (p > 2) {
        for (l = 0; l < p; l++)
          l === p - 2
            ? ((o = p - 2), (i = p - 1), (s = 0))
            : l === p - 1 ? ((o = p - 1), (i = 0), (s = 1)) : ((o = l), (i = l + 1), (s = l + 2)),
            (t = e[o]),
            (r = e[i]),
            (n = e[s]),
