          ...
          for (var g = 0; g < l; g++) {
            ...
            if (null !== (a = p ? c.geometries[g] : c)) {
              ...
              switch (((f = !r || ('Polygon' !== w && 'MultiPolygon' !== w) ? 0 : 1), w)) {
                ...
                case 'MultiPolygon':
                  for (o = 0; o < u.length; o++) {
                    for ('MultiPolygon' === w && (j = 0), i = 0; i < u[o].length; i++) {
  ...
  function(e, t, r) {
    ...
    var o = r(31),
      ...
      w = {
        ...
        area: 'Powierzchnia',
        perimeter: 'Obwód',
        pointLocation: 'Lokalizacja punktu',
        areaMeasurement: 'Pomiar powierzchni',
        linearMeasurement: 'Pomiar liniowy',
        pathDistance: 'Długość ścieżki',
        centerOnArea: 'Wyśrodkuj na tym obszarze',
        centerOnLine: 'Wyśrodkuj na tej linii',
        centerOnLocation: 'Wyśrodkuj w tej lokalizacji',
        cancel: 'Anuluj',
        delete: 'Usuń',
        acres: 'akrów',
        feet: 'stóp',
    ...
    (L.Control.Measure = L.Control.extend({
      ...
      initialize: function(e) {
        L.setOptions(this, e),
          (this.options.labels = Object.assign(Object.assign({}, w), this.options.labels));
        var t = this.options,
          r = t.activeColor,
          n = t.completedColor;
